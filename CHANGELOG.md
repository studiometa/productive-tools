...
[0.10.17]: https://github.com/studiometa/productive-tools/compare/0.10.16...0.10.17
...
- **MCP**: Add a single global `search_docs` tool for documentation discovery across everything the server exposes, over one shared index: no query returns a cross-domain table of contents; a query returns ranked matches across resources (drill in via `action=help`), raw API endpoints (drill in via `api_read describe`), and the run_script scripting API (full sections returned inline). Also adds `productive` `action=help` with a `query` for cross-resource search and `api_read` `search="<term>"` to discover endpoints by keyword (path now optional). Supersedes the separate `run_script_search_docs` tool, whose content is now part of `search_docs` ([#181])

[0.10.15]: https://github.com/studiometa/productive-tools/compare/0.10.14...0.10.15
...
[04b3fbe]: https://github.com/studiometa/productive-tools/commit/04b3fbe
[0c23003]: https://github.com/studiometa/productive-tools/commit/0c23003
[f89c28f]: https://github.com/studiometa/productive-tools/commit/f89c28f
...
[#127]: https://github.com/studiometa/productive-tools/issues/127
[#128]: https://github.com/studiometa/productive-tools/issues/128
